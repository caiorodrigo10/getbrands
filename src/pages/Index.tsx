  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Acompanhe o progresso do seu projeto</p>
      </header>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card className="p-5 bg-secondary hover:bg-secondary/90 transition-colors duration-200">
