...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Email enviado",
        description: "Se uma conta existir com este email, você receberá as instruções para redefinir sua senha.",
      });
      ...
      toast({
        variant: "destructive",
        title: "Erro",
        description: "Não foi possível enviar as instruções. Por favor, tente novamente.",
      });
    } finally {
      setIsLoading(false);
    }
