  ...
  return (
    <Card className="mb-4 sm:mb-6">
      ...
      <CardContent className="space-y-6 sm:space-y-8">
        <div>
          <h3 className="text-sm sm:text-base font-medium mb-3 sm:mb-4">Product Details</h3>
          <div className="grid gap-3 sm:gap-4">
            {orderDetails.sample_request_products.map(({ product }) => (
              <div key={product.id} className="flex items-start gap-3 sm:gap-4 bg-card border rounded-lg p-3 sm:p-4 shadow-sm">
                <img
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-sm sm:text-base mb-1">{product.name}</h4>
        ...
        <div>
          <h3 className="text-sm sm:text-base font-medium mb-3 sm:mb-4">Shipping Address</h3>
          <div className="bg-card border rounded-lg p-3 sm:p-4 shadow-sm">
            <p className="text-sm sm:text-base mb-1">{orderDetails.shipping_address}</p>
            <p className="text-sm sm:text-base mb-1">
              {orderDetails.shipping_city}, {orderDetails.shipping_state}{" "}
              {orderDetails.shipping_zip}
            </p>
            <p className="text-sm sm:text-base">United States</p>
          </div>
        </div>
      </CardContent>
    </Card>
