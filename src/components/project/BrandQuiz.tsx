...
export function BrandQuiz() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["brand_quiz", projectId] });
  ...
  const steps: QuizStep[] = [
    {
      id: 1,
      title: "Welcome to Brand Identity Quiz",
      description: "Let's define how your brand identity will be translated into label design.",
      component: (
        <div className="text-center space-y-6">
          <h3 className="text-2xl font-semibold">Welcome to Your Brand Identity Quiz</h3>
