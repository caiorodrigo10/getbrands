...
export const AppLayout = () => {
  ...
  // Don't show navigation menu for onboarding, auth pages and 404
  const hideNav = ['/login', '/signup', '/onboarding'].includes(location.pathname) || location.pathname.includes('404');
